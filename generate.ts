...
async function main() {
  ...
  const generatedConstants = [
    ...
    },
    {
      ...
      typeExpression: "(typeof VANTAGE_FINANCIAL_COMMITMENT_GROUPINGS)[number] | `tag:${string}`",
    ...
    },
    {
      ...
      typeExpression: "(typeof VANTAGE_KUBERNETES_EFFICIENCY_GROUPINGS)[number] | `label:${string}`",
